...
```csv
id,title,year,phase,desc,image
w001,作品标题,1885,1885,作品说明,/images/works/moon -1.jpg
```
...
- `title`
- `year`
- `phase`（1885 / 1886 / 1887–1888 / 1889–1892）
- `desc`
- `image`

你可以把 100 条贴成 CSV 文本，或分 10 批（每批 10 条）发给我，我可以直接帮你转成前端数据数组。
