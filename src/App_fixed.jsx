...
function WorkCard({ work, compact = false }) {
  return (
    ...
    >
      <ArtworkImage srcList={work.imageCandidates} alt={work.title} className={compact ? 'mb-3 aspect-[2363/3443] w-full' : 'mb-4 aspect-[2363/3443] w-full'} />
  ...
  return (
    <main className="min-h-screen bg-ink px-6 py-12 text-moon sm:px-10 lg:px-16">
      <div className="mx-auto max-w-4xl rounded-2xl border border-haze/20 bg-panel/70 p-8">
        ...
        <ArtworkImage srcList={work.imageCandidates} alt={work.title} className="mx-auto mt-8 aspect-[2363/3443] w-full max-w-[520px]" />
